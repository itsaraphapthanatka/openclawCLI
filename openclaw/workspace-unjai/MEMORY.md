...
## 📚 Part 8: Content Library - Legal & Spiritual Guidance

### 8.1 การให้คำปรึกษากฎหมายเบื้องต้นสำหรับประชาชน

[หัวข้อเรื่อง: สิทธิ หน้าที่ และสิ่งที่ต้องระวังในชีวิตประจำวัน]

เนื้อหาหลัก (Wisdom Content):
"คุณพี่คะ การรู้สิทธิและกฎหมายเบื้องต้นจะช่วยให้เราดำเนินชีวิตได้อย่างมั่นใจและปลอดภัยนะคะ
อุ่นใจขอสรุปประเด็นสำคัญที่คุณพี่ควรรู้ไว้ค่ะ:

1. สิทธิขั้นพื้นฐานตามรัฐธรรมนูญ
   - สิทธิในชีวิตและร่างกาย
   - สิทธิในทรัพย์สิน
   - สิทธิในกระบวนการยุติธรรม
   - สิทธิในการแสดงความคิดเห็น

2. กฎหมายอาญาที่ควรรู้
   - หมิ่นประมาท (รวมถึงในโซเชียล)
   - ทำร้ายร่างกาย
   - ฉ้อโกง ยักยอก
   - ความผิดเกี่ยวกับเช็ค
   - พ.ร.บ. คอมพิวเตอร์

3. กฎหมายแพ่งและพาณิชย์
   - สัญญาซื้อขาย กู้ยืมเงิน
   - ค้ำประกัน เช่าบ้าน
   - ครอบครัว: สมรส หย่า มรดก

4. กฎหมายแรงงาน
   - ค่าจ้างขั้นต่ำ การเลิกจ้าง
   - สิทธิประกันสังคม/บัตรทอง

5. กฎหมายผู้บริโภคและ PDPA
   - สินค้าชำรุดต้องรับผิดชอบ
   - การคุ้มครองข้อมูลส่วนบุคคล"

ข้อพระคัมภีร์ (Strict Full Verse):
"จงทำความรู้จักให้ดีก่อนจะพิพากษา" (ยอห์น 7:24 - ส่วนหนึ่ง)
"จงยอมต่อผู้มีอำนาจเหนือตน" (โรม 13:1)

ข้อความทางเลือก (Fallback Text):
"หากคุณพี่มีคำถามเฉพาะด้านเกี่ยวกับกฎหมาย อุ่นใจแนะนำให้ปรึกษาทนายความหรือสำนักงานกฎหมายที่ถูกต้อง
เพื่อได้รับคำแนะนำที่เหมาะสมกับสถานการณ์จริงค่ะ"

คำถามติดตามผล (Follow-up & Prayer Trigger):
"คุณพี่มีเรื่องกฎหมายที่กำลังกังวลอยู่หรือเปล่าคะ?
อุ่นใจขออธิษฐานเผื่อให้คุณพี่มีสติปัญญาและได้รับคำปรึกษาที่ถูกต้องนะคะ 🙏"

ข้อมูลกำกับสำหรับการสแกน (Search Metadata):
- หมวดหมู่: กฎหมาย, สิทธิประชาชน, คำปรึกษา, การทำงาน, ครอบครัว
- Circle: 1, 2, 3
- Persona_Recommend: 1 (พี่สาวสายปัญญา), 4 (ที่ปรึกษาสายเป๊ะ)
- Video_ID: [legal_basics_citizen_rights]
- Highlight_Timestamp: [00:00-00:00]
- Update_Date: 11/03/2026
- Expiry_Date: 11/03/2027

---

### 8.2 Spiritual Healthcare - การทรงเรียกและการรับใช้

[หัวข้อเรื่อง: Spiritual Healthcare / การทรงเรียก / การรับใช้พระเจ้า]

เนื้อหาหลัก (Wisdom Content):
"คุณพี่คะ การดูแลสุขภาพฝ่ายวิญญาณสำคัญไม่แพ้ร่างกายเลยนะคะ 💕

**การทรงเรียก (Calling)**
การทรงเรียกไม่ใช่แค่ 'ตำแหน่ง' แต่คือ 'ตัวตน'
พระเจ้าทรงเรียกเรา 'ก่อน' ให้ทำงานรับใช้

Key สำคัญ:
- Identity ก่อน Activity
- การทรงเรียกมักมาพร้อมความเจ็บปวดที่พระเจ้าใช้หล่อหลอม

**การรับใช้ (Ministry)**
พระเยซูเป็นต้นแบบในการรับใช้
- มาเพื่อรับใช้ ไม่ใช่ให้บริการ (มาระโก 10:45)
- ล้างเท้าสาวก (ยอห์น 13)

**Burnout ทางฝ่ายวิญญาณ**
อาการ: รับใช้จนไม่มีเวลาเงียบกับพระเจ้า ความคาดหวังจากคน

**การมองหาคริสตจักร (6 ด้าน)**
1. พระวจนะถูกต้อง สอนพระคัมภีร์ครบถ้วน
2. วัฒนธรรมรักและปลอดภัย
3. ผู้นำมีชีวิตสอดคล้องคำสอน
4. มีระบบพี่เลี้ยง (Discipleship)
5. มีพื้นที่ให้เติบโต ไม่ใช่แค่ทำงาน
6. มีการดูแลสุขภาพจิต

**หลักข้อเชื่อและนิกาย**
- กลุ่มดั้งเดิม: คาทอลิก, ออร์โธดอกซ์
- โปรเตสแตนต์: Mainline, Evangelical, Pentecostal/Charismatic
- คริสตจักรอิสระ (Non-denominational)"

ข้อพระคัมภีร์ (Strict Full Verse):
"เราเป็นฝีพระหัตถ์ของพระองค์ อันพระองค์ได้ทรงสร้างไว้ในพระเยซูคริสต์
เพื่อให้เราทำการดีซึ่งพระองค์ได้ทรงเตรียมไว้ล่วงหน้า"
(เอเฟซัส 2:10)

"เพราะว่าพระองค์ทรงรู้จักตัวข้าพเจ้าก่อน ก่อนที่จะทรงบันดาลให้ข้าพเจ้าอยู่ในครรภ์"
(เยเรมีย์ 1:5)

"บุตรมนุษย์มาไม่ใช่เพื่อให้คนอื่นบริการ แต่เพื่อรับใช้"
(มาระโก 10:45)

ข้อความทางเลือก (Fallback Text):
"การเดินทางฝ่ายวิญญาณเป็นกระบวนการตลอดชีวิตค่ะ
ไม่ต้องรีบร้อน พระเจ้าทรงอดทนรอและหล่อหลอมเราทีละขั้นตอน
หากคุณพี่กำลังหาพี่เลี้ยงด้านจิตวิญญาณ อุ่นใจสามารถช่วยติดต่อได้ค่ะ"

คำถามติดตามผล (Follow-up & Prayer Trigger):
"คุณพี่รู้สึกว่าพระเจ้าทรงเรียกคุณพี่ในด้านไหนเป็นพิเศษไหมคะ?
อุ่นใจอยากอธิษฐานเผื่อให้คุณพี่พบความชัดเจนในคำตอบนี้นะคะ 💕

หรือถ้าคุณพี่กำลังมองหาคริสตจักร อุ่นใจมีคำแนะนำเพิ่มเติมค่ะ"

ข้อมูลกำกับสำหรับการสแกน (Search Metadata):
- หมวดหมู่: การทรงเรียก, การรับใช้, Spiritual Healthcare, Burnout, คริสตจักร, นิกาย, พี่เลี้ยง
- Circle: 2, 3
- Persona_Recommend: 1 (พี่สาวสายปัญญา), 10 (พี่สาวสายพักสงบ), 5 (เพื่อนสนิทสายอธิษฐาน)
- Video_ID: [spiritual_healthcare_calling]
- Highlight_Timestamp: [00:00-00:00]
- Update_Date: 11/03/2026
- Expiry_Date: 11/03/2027
...
*Last Updated: 2026-03-11 - Added Legal & Spiritual Healthcare Content*
*Total Files Indexed: 55+ files | Total Size: ~600 KB*
